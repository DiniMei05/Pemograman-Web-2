...
<html lang="en">
  <head>
    ...
    <title>Toko skincare Sacaelett</title>
  ...
  <body>
    <div class="container">
        ...
        <div class="row bg-primary-subtle m-1">
                <div class="col-6 p-5">
                    <h1>Selamat datang Di Toko Skincare Sacaelett Online</h1>
                    <p>Kami Menyediakan skincare Sacaelett yang lengkap</p>
                    <a href="#" class="btn btn-success">Lihat Produk</a>
                </div>
                <div class="col-6 p-5">
                    <h1>Temukan skincare Sacaelett kamu sesuai kebutuhan kulit wajah anda</h1>
                    <form action="">
                        <div class="mb-3">
                            <input type="text" class="form-control"
                            placeholder=" id skincare ">
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control"
                            placeholder="nama sacaelett">
                        </div>
                        <div class="mb-3"></div>
                            <input type="text" class="form-control"
                            placeholder="kategori sacaelett">
                            <div class="mb-3">
            ...
            <div class="col-3">
                <div class="card">
                <img src="<?= base_url('images/sa02.jpg') ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Paket Sacaelett Acne</h5>
            ...
            <div class="col-3">
                <div class="card">
                <img src="<?= base_url('images/ss02.jpg') ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Paket Anti Aging</h5>
                      <p class="card-text">Rp. 250.000,-</p>
                      <a href="#" class="btn btn-primary">add to chart</a>
                    </div>
                  </div>
            ...
            <div class="col-3">
                <div class="card">
                <img src="<?= base_url('images/sss02') ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Paket Sacaelett brighly</h5>
                      <p class="card-text">Rp. 250.000,-</p>
                      <a href="#" class="btn btn-primary">add to chart</a>
                    </div>A
                  </div>
