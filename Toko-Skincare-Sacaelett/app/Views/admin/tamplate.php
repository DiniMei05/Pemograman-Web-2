...
<html lang="en">
  <head>
    ...
    <title>Admin Toko SKINCARE SCARLETT</title>
  ...
  <body>
        ...
        <div class="row">
            <div class="col-3">
                <ul>
                    ...
                    <li>
                        <a href="<?=base_url('admin/daftar-skincare')?>" class="">Daftar-skincare</a>
                    </li>
                    <li>
    ...
    <footer class="bg-succes text text-white py-3 text">
        <div class="container">
            Coopyright 2024,  toko skincare sacaelett kelas B, All right reserved
        </div>
    </footer>
    <?= $this->renderSection('main') ?>
    </div>
